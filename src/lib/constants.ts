...
// Rich product catalog grouped by subcategory slug
export const CHALDAL_PRODUCTS: Product[] = [
  // MEAT Products (Matching Screenshot 1:1)
  {
    id: 'meat-1',
  ...
  {
    id: 'meat-5',
    name: 'Cock Chicken Skin Off ± 25 gm',
    price: 339,
    originalPrice: 375,
    unit: '500 gm',
    deliveryTime: '3 hrs',
  ...
  {
    id: 'meat-10',
    name: 'Chicken Liver (Kolija) ± 25 gm',
    price: 199,
    unit: '500 gm',
    deliveryTime: '3 hrs',
    image: 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=400&auto=format&fit=crop&q=80',
  ...
  {
    id: 'meat-13',
    name: 'Bengal Meat Chicken Thigh Keema ± 50 gm',
    price: 635,
    unit: '1 kg',
    deliveryTime: '3 hrs',
    image: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=400&auto=format&fit=crop&q=80',
