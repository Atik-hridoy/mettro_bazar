  ...
  return (
    <div className="w-full min-h-[calc(100vh-3.5rem)] bg-white px-4 sm:px-6 py-6 pb-20">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-zinc-800 tracking-tight mb-4">
        {isBN ? 'জনপ্রিয় পণ্যসমূহ' : 'Popular Products'}
      </h1>
      ...
      {loading ? (
        <div className="py-12 text-center text-xs text-zinc-400 font-medium animate-pulse">
          {isBN ? 'পণ্যসমূহ লোড হচ্ছে...' : 'Loading popular products...'}
        </div>
      ) : products.length === 0 ? (
        <EmptyState
          title="কোনো জনপ্রিয় পণ্য পাওয়া যায়নি"
          titleBn="কোনো জনপ্রিয় পণ্য পাওয়া যায়নি"
          description="বর্তমানে ক্যাটালগে কোনো পণ্য যুক্ত নেই। অনুগ্রহ করে এডমিন প্যানেল থেকে পণ্য যুক্ত করুন।"
          descriptionBn="বর্তমানে ক্যাটালগে কোনো পণ্য যুক্ত নেই। অনুগ্রহ করে এডমিন প্যানেল থেকে পণ্য যুক্ত করুন।"
          actionHref="/"
